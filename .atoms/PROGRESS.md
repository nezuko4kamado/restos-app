...
- 2026-08-29 | Fix camera Android definitivo: rimosso capture=environment da tutti gli input file, unificati Camera+Galleria in pulsante singolo accept=image/* multiple; Android mostra menu nativo; lint OK, build OK
