...
- 2026-08-29 | Fix camera Android overlay: sostituito sr-only con style position:absolute inset:0 opacity:0 su tutti gli input file in ProductsSectionEnhanced (2), MultiPageInvoiceUpload (4) e SupplierDetail (2); label con relative; lint OK, build OK
