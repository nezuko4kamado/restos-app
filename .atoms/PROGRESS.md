...
- 2026-08-29 | Added cameraOverlay render to MultiPageInvoiceUpload.tsx; confirmed SupplierDetail.tsx already uses native label+input pattern; lint OK, build OK
...
- 2026-08-29 | Fix camera Android overlay: sostituito sr-only con style position:absolute inset:0 opacity:0 su tutti gli input file in ProductsSectionEnhanced (2), MultiPageInvoiceUpload (4) e SupplierDetail (2); label con relative; lint OK, build OK; pushed commit 49fd6f3
- 2026-08-29 | Fix camera Android definitivo: rimosso capture=environment da tutti gli input file, unificati Camera+Galleria in pulsante singolo accept=image/* multiple; Android mostra menu nativo; lint OK, build OK; pushed commit 37130bc
