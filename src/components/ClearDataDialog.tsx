...
export function ClearDataDialog({ open, onOpenChange, onConfirm }: ClearDataDialogProps) {
  const { t } = useLanguage();
      ...
      <AlertDialogContent className="max-w-md">
        ...
        <AlertDialogFooter className="gap-2 sm:gap-0">
          ...
          <AlertDialogAction
            ...
            disabled={isDeleting}
            className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isDeleting ? t('processingInProgress') : t('yes')}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
